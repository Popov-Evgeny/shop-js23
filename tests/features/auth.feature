#language: ru
  ...
  Сценарий: Логин пользователя
    Допустим я нахожусь настранице "/login"
    Если  я ввожу "user@user.local" в поле "E-mail"
    И я ввожу "123Qwerty%" в поле "password"
    И я нажимаю на кнопку "Sign In"
    То я вижу текст "HELLO USER@USER.LOCAL!"